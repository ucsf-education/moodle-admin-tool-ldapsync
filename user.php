...
class ldapsync_purgeusers_action_form extends moodleform {
    ...
    $returnurl = new moodle_url('/admin/tool/ldapsync/user.php', array('sort' => $sort, 'dir' => $dir, 'perpage' => $perpage, 'page'=>$page));
...
if ($data = $action_form->get_data()) {
    ...
    $baseurl = new moodle_url('/admin/tool/ldapsync/user.php', array('sort' => $sort, 'dir' => $dir, 'perpage' => $perpage));
